    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden bg-card"
        >
      ...
      <div className="w-full h-full -mt-7 flex-none inset-0">
        ...
        >
          <motion.div
            ...
            className="absolute left-1/2 top-1/2 h-[11.25rem] w-[11.25rem] rounded-[50%] bg-primary/[0.08]"
          />
          <motion.div
            initial={{ opacity: 0, scale: 0, x: "-50%", y: "-50%" }}
            animate={{ opacity: [0, 1, 0.5, 0], scale: 1, z: 0 }}
